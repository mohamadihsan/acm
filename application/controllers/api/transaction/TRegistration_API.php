    ...
    public function check_registration_post()
    {
        ...
        if($token){        
            ...
            if($this->token_validation->check($token)){
                ...
                if($response = $this->Registration_model->check($uid, $c_card, $i_card_type, $c_people, $c_company, $i_user)){
    ...
    public function registration_post()
    {
        ...
        if($token){        
            ...
            if($this->token_validation->check($token)){
                ...
                // insert data macm.t_m_desc
                if($response = $this->Registration_model->insert($uid, $c_card, $i_card_type, $c_people, $c_company, $i_user)){

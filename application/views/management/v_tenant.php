...
<div id="modalexport" class="modal fade" tabindex="-1" data-backdrop="static" data-keyboard="false" data-attention-animation="false">
    <!-- <form id="exportExcel"> -->
    <form action="<?= base_url().'tenant/export' ?>" method="POST">
        <div class="modal-body">
        ...
        <div class="modal-body">
            ...
            <input type="hidden" name="type_people" value="tenant">
        </div>
        <div class="modal-footer">
            <button type="button" data-dismiss="modal" class="btn btn-outline dark">Cancel</button>
            <button type="submit" class="btn blue">Export</button>
            <!-- <a href="<?= base_url().'tenant/export' ?>" class="btn blue" target="_blank">Export</a> -->
        </div>
    </form>
</div>
<!-- END MODAL EXPORT -->

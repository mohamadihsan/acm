        ...
        <div class="sidebar">
            <div class="sidebar-inner">
                        ...
                        <div class="peer peer-greed">
                            <a class="sidebar-link td-n" href="index.html">
                                <div class="peers ai-c fxw-nw">
                                    ...
                                    <div class="peer peer-greed">
                                        <h5 class="lh-1 mB-0 logo-text">Commuter</h5>
                                    </div>
                                </div>
                            </a>
                        </div>
                ...
                <ul class="sidebar-menu scrollable pos-r">
                    ...
                    <li class="nav-item">
                        <a class="sidebar-link" href="<?= site_url('card') ?>">
                            <span class="icon-holder">
                                <i class="c-blue-500 ti-credit-card"></i>
                            </span>
                    ...
                    <li class="nav-item dropdown">
                        <a class="dropdown-toggle" href="javascript:void(0);">
                            ...
                            <span class="title">People Management</span>
                            <span class="arrow">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a class="sidebar-link" href="<?= site_url('people/employee') ?>">Employee</a>
                            </li>
                            <li>
                                <a class="sidebar-link" href="<?= site_url('people/non_employee') ?>">Non Employee</a>
                            </li>
                            <li>
                                <a class="sidebar-link" href="<?= site_url('people/tenant') ?>">Tenant / Vendor</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a class="sidebar-link" href="<?= site_url('report/registration') ?>">Registration</a>
                            </li>
                            <li>
                                <a class="sidebar-link" href="<?= site_url('report/replacement') ?>">Replacement</a>
                            </li>
                            <li>
                                <a class="sidebar-link" href="<?= site_url('report/deletion') ?>">Card Deletion</a>
                            </li>
                            <li>
                                <a class="sidebar-link" href="<?= site_url('report/update_card') ?>">Update Card</a>
                            </li>
                            <li>
                                <a class="sidebar-link" href="<?= site_url('report/card_blocked') ?>">Card Blocked</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item">
                    ...
                    <ul class="nav-right">
                        ...
                        <li class="dropdown">
                            <a href="" class="dropdown-toggle no-after peers fxw-nw ai-c lh-1" data-toggle="dropdown">
                                ...
                                <img class="w-2r bdrs-50p" src="<?= base_url() ?>assets/static/images/logo.png" alt="">
                                </div>
                                <div class="peer">
                                <span class="fsz-sm">Admin</span>
                                </div>
                            </a>
                            <ul class="dropdown-menu fsz-sm">
                                ...
                                <li>
                                    <a href="<?= base_url() ?>api/logout" class="d-b td-n pY-5 bgcH-grey-100 c-grey-700">
